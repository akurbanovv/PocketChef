...
function Profile(props) {
    ...
    if (!user) {
        return (<div style={{textAlign: "center"}}><img src={Loading} alt="Loading..."
                                                        style={{margin: "auto", height: "15%", width: "15%"}}/>
            <h3>scrambling eggs. . .</h3></div>);
            ...
            <section id="profile-info">
                ...
                <div className="container row">
                    <div className="col-lg-5 offset-lg-3">
                        <img
                            src="https://ih1.redbubble.net/image.782439743.8716/st,small,845x845-pad,1000x1000,f8f8f8.jpg"
                            style={{height: "30vh", width: "70%", margin: "15%", borderRadius: "50%"}}/>
                    </div>
                    <div className="col-lg-4">
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">Name</span>
                            <input type="text" class="form-control" id="fullname" placeholder={user.fullname}
                        ...
                        <button type="button" className="btn btn-success" onClick={submitProfileChanges}>Submit
                            Changes
                        </button>
                    </div>
                </div>
                ...
                <div style={{marginLeft: "5%"}}>
                    ...
                    <div className="row flex-row flex-nowrap"
                        ...
                        {user.savedArticles.map((article, idx) => {
                            return (
                                <div id={idx} className="card profile_card">
                                    <Link to={{
                                        pathname: "/article",
                                        state: {
                                            article: article
