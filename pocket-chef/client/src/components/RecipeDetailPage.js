...
const saveRecipe = (recipe) => {
    $.post('/node_save_recipe', recipe).done((data) => {
        if (data.message === "success" || data.message === "recipe already saved") {
            //salert("Recipe saved");
        } else {
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="recipe_description col-xl-8 col-lg-8">
                    ...
                    {
                        currentUser ?
                            <button className='bookmark_button btn' id="save-recipe-btn" onClick={saveRecipe(recipe)}>
            ...
            <div className="row inginst">
                <div className="col-lg-4">
                    <h1 className="margin">Ingredients</h1>
                ...
                <div className="col-lg-8">
                    <h1 className="margin">Instructions</h1>
                    {
